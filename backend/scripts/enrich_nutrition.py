...
Usage:
    ...
    python scripts/enrich_nutrition.py                  # all missing
...
def enrich(db_path: Path, api_key: str, limit: int, dry_run: bool) -> None:
    ...
    for i, row in enumerate(rows, 1):
        ...
        if data is None:
            ...
            fields = ["calories_kcal", "sugar_g", "saturated_fat_g", "sodium_mg",
                      "protein_g", "fiber_g", "serving_size_g", "ingredients_raw", "nova_class"]
...
def main() -> None:
    ...
    enrich(args.db, api_key, args.limit, args.dry_run)
